sap.ui.define(
  ...
  function (
    ...
    return BaseController.extend("com.order.html5.controller.Master", {
      formatter: formatter,
      ...
      onOpenViewSettings: function (oEvent) {
        ...
        if (!this.byId("viewSettingsDialog")) {
          Fragment.load({
            ...
            name: "com.order.html5.view.ViewSettingsDialog",
            controller: this,
          }).then(
            function (oDialog) {
      ...
      _onMasterMatched: function () {
        ...
        if (startupParams.OrderID && startupParams.OrderID[0]) {
          this.getRouter().navTo(
            "object",
            {
              objectId: startupParams.OrderID[0], // read Supplier ID. Every parameter is placed in an array therefore [0] holds the value
            },
            true
          );
        } else {
