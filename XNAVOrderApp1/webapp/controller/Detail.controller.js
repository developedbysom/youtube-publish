sap.ui.define(
  ...
  function (BaseController, JSONModel, formatter, mobileLibrary) {
    ...
    return BaseController.extend("com.order.html5.controller.Detail", {
      formatter: formatter,
      ...
      fireTitlePress: function (oEvent) {
        var title = oEvent.getSource().getProperty("text");
        var customerID = title.split(":")[1].trim();
