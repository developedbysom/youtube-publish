sap.ui.define(
  ...
  function (
    ...
    return BaseController.extend("com.customer.customer.controller.Master", {
      formatter: formatter,
      ...
      onOpenViewSettings: function (oEvent) {
        ...
        if (!this.byId("viewSettingsDialog")) {
          Fragment.load({
            ...
            name: "com.customer.customer.view.ViewSettingsDialog",
            controller: this,
          }).then(
            function (oDialog) {
      ...
      _onMasterMatched: function () {
        ...
        //Cross App Navigation changes start - branch-xnav0
        var customerID;
        var startupParams =
          this.getOwnerComponent().getComponentData().startupParameters; // get Startup params from Owner Component
        if (startupParams.customerID && startupParams.customerID[0]) {
          this.getRouter().navTo(
            "object",
            {
              objectId: startupParams.customerID[0], // read Supplier ID. Every parameter is placed in an array therefore [0] holds the value
            },
            true
          );
        } else {
          this.getOwnerComponent().oListSelector.oWhenListLoadingIsDone.then(
            function (mParams) {
              ...
              customerID = mParams.firstListitem
                .getBindingContext()
          ...
          //Cross App Navigation changes end - branch-xnav0
        }
      },
