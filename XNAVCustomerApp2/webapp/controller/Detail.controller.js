sap.ui.define(
  ...
  function (BaseController, JSONModel, formatter, mobileLibrary) {
    ...
    return BaseController.extend("com.customer.customer.controller.Detail", {
      formatter: formatter,
      ...
      fireOrderPress: function (oEvent) {
        var orderId = oEvent.getSource().getProperty("title");
        ...
        var hash =
          ...
          ""; // generate the Hash to display a customer
